<template>
    ...
    <div class="min-h-screen bg-gray-100 flex flex-col">
        ...
        <div class="flex flex-1 overflow-hidden">
            ...
            <aside class="w-2/3 flex flex-col border-r border-gray-200 bg-white">
                <!-- Zoekbalk (US-9) -->
                <div class="p-4 border-b flex gap-3">
                    ...
                    <!-- Categorie filter (US-9) -->
                    <select v-model="activeCategory" class="form-input w-48">
            ...
            <main class="w-1/3 flex flex-col bg-white p-4">
                ...
                <div class="flex-1 overflow-y-auto space-y-2">
                    ...
                    <!-- Orderregel (US-10 opmerking, US-11 rijstkeuze) -->
                    ...
                    >
                        <div class="flex items-center justify-between gap-2">
                            ...
                            <div class="flex items-center gap-1">
                                ...
                                <button @click="removeItem(idx)" class="w-7 h-7 text-red-400 hover:text-red-600 rounded font-bold text-lg">✕</button>
                            </div>
                        </div>
